...
#counter is "\PhysicalDisk(_Total)\Avg. Disk sec/Write"
...
$all= (get-counter -ComputerName $computername `
 ...
 #  powershell -command .\physicDisk_Write.ps1
